...
CryptoErrorCode mapErrorCode(int32_t rustErrorCode) {
    switch (rustErrorCode) {
        case static_cast<int32_t>(crypto::CryptoErrorCode::InvalidParams):
            return CryptoErrorCode::InvalidPassword;
        case static_cast<int32_t>(crypto::CryptoErrorCode::AuthenticationFailed):
            return CryptoErrorCode::AuthenticationFailed;
        case static_cast<int32_t>(crypto::CryptoErrorCode::EncryptionError):
        case static_cast<int32_t>(crypto::CryptoErrorCode::DecryptionError):
            return CryptoErrorCode::DataCorrupted;
        case static_cast<int32_t>(crypto::CryptoErrorCode::KeyDerivationError):
            return CryptoErrorCode::InvalidPassword;
        default:
...
std::string getErrorMessage(int32_t errorCode) {
    switch (errorCode) {
        ...
        case static_cast<int32_t>(crypto::CryptoErrorCode::BufferTooSmall):
            return "Buffer too small";
        case static_cast<int32_t>(crypto::CryptoErrorCode::InternalError):
...
std::vector<uint8_t> Crypto::encrypt(
    ...
    if (result != 0) {
        if (result == static_cast<int32_t>(crypto::CryptoErrorCode::BufferTooSmall)) {
