...
4. [PC Deployment](#4-pc-deployment)
5. [Embedded Deployment](#5-embedded-deployment)
...
flowchart TD
    ...
    classDef arm fill:#e8e8e8,stroke:#333,color:#333,margin-top:40px;
...
### 8.7 Cryptographic Implementation
